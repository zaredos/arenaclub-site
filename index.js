...
var MemStorage = class {
  ...
  constructor() {
    ...
    this.suggestions = /* @__PURE__ */ new Map();
  }
  async getUser(id) {
...
var insertSuggestionSchema = createInsertSchema(suggestions).pick({
  name: true,
  email: true,
  type: true,
  suggestion: true
...
async function registerRoutes(app2) {
  ...
  app2.get("/api/suggestions", async (req, res) => {
    try {
      const suggestions2 = await storage.getAllSuggestions();
